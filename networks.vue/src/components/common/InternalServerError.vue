<template>
    <div class="page-error">
        <article class="page-error__content">
            ...
            <h1 class="page-error__title" v-lang.httpErrors.error500></h1>

            <div class="page-error__text" v-lang.httpErrors.error500description></div>
...
<script>
    export default {
        ...
        head: {
            title: function () {
                return {
                    inner: this.translate('httpErrors.error500')
                };
            }
        }
    }
